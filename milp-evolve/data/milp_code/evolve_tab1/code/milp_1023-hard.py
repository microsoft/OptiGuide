...
class SupplyChainOptimization:
    ...
    def solve(self, instance):
        ...
        # Constraints
        # Demand satisfaction (total supplies and unmet demand must cover total demand)
        for d in range(n_demand_points):
            model.addCons(quicksum(transport_vars[f, d] for f in range(n_factories)) + unmet_demand_vars[d] == demands[d], f"Demand_Satisfaction_{d}")
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'max_cost_transport': 200,
        'min_capacity_factory': 1400,
        'max_capacity_factory': 2000,
        'min_demand': 50,
        'max_demand': 1600,
    }
