...
class SupplyChainOptimization:
    ...
    def generate_instance(self):
        ...
        capacities = np.full(self.n_factories, self.fixed_capacity)  # All factories have the same capacity
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'min_cost_transport': 1,
        'max_cost_transport': 250,
        'fixed_capacity': 1500,
        'min_demand': 5,
        'max_demand': 200,
    }
