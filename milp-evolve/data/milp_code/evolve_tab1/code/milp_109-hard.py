...
class SimpleSupplyChainNetwork:
    ...
    def solve(self, instance):
        ...
        model = Model("SimpleSupplyChainNetwork")
        ...
        for i in range(supply_nodes):
            model.addCons(quicksum(flow_vars[(i, j)] for j in range(demand_nodes) if (i, j) in arcs) <= supply_capacities[i] * arc_vars[i], f"supply_capacity_{i}")
...
if __name__ == '__main__':
    ...
    supply_chain_problem = SimpleSupplyChainNetwork(parameters, seed=seed)
