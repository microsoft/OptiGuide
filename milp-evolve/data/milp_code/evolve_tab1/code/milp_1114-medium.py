...
class SupplyChainOptimization:
    ...
    def generate_instance(self):
        ...
        # Generate relational constraints between factories
        relational_constraints = []
        for _ in range(self.num_relational_constraints):
            factory_1, factory_2 = np.random.choice(self.n_factories, 2, replace=False)
            relational_constraints.append((factory_1, factory_2))
    ...
    def solve(self, instance):
        ...
        relational_constraints = instance['relational_constraints']
        ...
        # Relational constraints between factories (if one is open, the other must not be, etc.)
        for (factory_1, factory_2) in relational_constraints:
            for t in range(n_periods):
                model.addCons(
                    factory_vars[factory_1, t] + factory_vars[factory_2, t] <= 1, 
                    f"Relational_Constraint_{factory_1}_{factory_2}_Period_{t}"
                )
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'min_cost_transport': 2,
        'max_cost_transport': 21,
        'min_cost_transship': 4,
        'max_cost_transship': 750,
        'min_capacity_factory': 70,
        'max_capacity_factory': 250,
        'min_demand': 2,
        'max_demand': 480,
        'num_relational_constraints': 15,
    }
