...
if __name__ == "__main__":
    ...
    parameters = {
        ...
        'min_facility_space': 27,
        'max_facility_space': 337,
        'mean_demand': 1050,
        'std_dev_demand': 150,
        'graph_density': 0.52,
        'bigM': 10000,
        ...
        'social_impact_weight': 7.5,
        'carbon_emission_weight': 10.0,
        'transport_distance_factor': 0.45,
        'max_transport_threshold': 10.0,
    }
