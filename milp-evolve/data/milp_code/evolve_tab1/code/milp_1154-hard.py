...
class ManufacturingOptimization:
    ...
    def solve(self, instance):
        ...
        model.setObjective(
            ...
            1000 * quicksum(waste_emission_vars[m] for m in range(n_machines)), "minimize"
        )
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'min_task_cost': 50,
        'max_task_cost': 2000,
        'min_machine_cost': 800,
        'max_machine_cost': 3000,
        'min_machine_capacity': 100,
        'max_machine_capacity': 1000,
        'affinity': 15,
        'min_env_impact': 0.5,
        'max_env_impact': 1000.0,
        'min_labor_cost': 10,
        'max_labor_cost': 100,
        'min_raw_material_cost': 20,
        'max_raw_material_cost': 200,
        'min_waste_limit': 5,
        'max_waste_limit': 50
    }
