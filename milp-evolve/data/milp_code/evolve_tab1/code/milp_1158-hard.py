...
class HealthcareFacilityOptimization:
    ...
    def solve(self, instance):
        ...
        # Constraints: Healthcare facilities cannot exceed their capacity
        for f in range(number_of_facilities):
            model.addCons(quicksum(region_demands[r] * region_vars[f, r] for r in range(number_of_regions)) <= facility_capacities[f], f"Facility_{f}_Capacity")
        ...
        for f in range(number_of_facilities):
            model.addCons(service_cost_vars[f] == serve_costs[f] * facility_capacities[f] * facility_vars[f], f"Facility_{f}_ServeCost")
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'Number_of_Regions': 200,
        'Region_Cost_Lower_Bound': 5,
        'Region_Cost_Upper_Bound': 2500,
