...
if __name__ == "__main__":
    ...
    parameters = {
        ...
        'graph_density': 0.1,
        'bigM': 10000,
        'min_social_impact': 37,
        'max_social_impact': 1500,
        'min_carbon_emission': 5.0,
        'max_carbon_emission': 37.5,
        'social_impact_weight': 1.12,
        'carbon_emission_weight': 1.5,
        'transport_distance_factor': 0.1,
        'min_flow_capacity': 500,
        'max_flow_capacity': 1500,
        'min_flow_cost': 9.0,
        'max_flow_cost': 100.0,
    }
