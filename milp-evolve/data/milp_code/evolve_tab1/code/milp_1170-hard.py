...
class ResidentialZoneDevelopment:
    ...
    def solve(self, instance):
        ...
        model = Model("ResidentialZoneDevelopmentSimplified")
        ...
        model.setObjective(
            ...
            quicksum(zone_costs[m, z] * zone_vars[m, z] for m in range(n_markets) for z in range(n_zones)), "minimize"
        )
