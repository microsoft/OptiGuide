...
class DataCenterResourceAllocation:
    ...
    def solve(self, instance):
        ...
        model.setObjective(
            ...
            50 * quicksum(performance_impact[c] * performance_impact_vars[c] for c in range(n_centers)), "minimize"
        )
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'min_center_capacity': 564,
        'max_center_capacity': 2024,
        'affinity': 2,
        'flow_cost_range_min': 11,
        'flow_cost_range_max': 75,
        'min_migration_cost': 1050,
        'max_migration_cost': 3000,
        'min_hw_health': 0.38,
        'max_hw_health': 75.0,
        'min_usage_amount': 150,
        'max_usage_amount': 250,
