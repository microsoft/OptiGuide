...
class WarehouseLayoutOptimization:
    ...
    def solve(self, instance):
        ...
        # Simplified carbon emission constraints
        for f in range(n_facilities):
            for u in range(n_units):
...
if __name__ == "__main__":
    ...
    parameters = {
        ...
        'min_facility_cost': 2340,
        'max_facility_cost': 5000,
        'min_facility_space': 555,
        'max_facility_space': 1012,
        'mean_demand': 525,
        'std_dev_demand': 222,
        'graph_density': 0.66,
        'bigM': 10000,
        'min_carbon_emission': 22.5,
        'max_carbon_emission': 2812.5,
        'carbon_emission_weight': 52.5,
        'transport_distance_factor': 0.52,
        'min_flow_capacity': 1250,
        'max_flow_capacity': 3000,
        'min_flow_cost': 27.0,
        'max_flow_cost': 2700.0,
    }
