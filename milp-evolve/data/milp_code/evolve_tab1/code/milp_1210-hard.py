...
class FleetManagement:
    ...
    def solve(self, instance):
        ...
        for count, group in enumerate(incompatibilities):
            model.addCons(quicksum(truck_vars[node] for node in group) <= 1, f"Incompatibility_{count}")
...
if __name__ == '__main__':
    ...
    parameters = {
        'Number_of_Trucks': 82,
        'Number_of_Routes': 112,
        'Route_Cost_Lower_Bound': 45,
        'Route_Cost_Upper_Bound': 3000,
        'Min_Truck_Cost': 1686,
        'Max_Truck_Cost': 5000,
        'Min_Truck_Capacity': 787,
        'Max_Truck_Capacity': 945,
        'Affinity': 11,
    }
