...
class NeighboorhoodElectricVehicleOptimization:
    ...
    def solve(self, instance):
        ...
        for l in range(n_locations):
            ...
            model.addCons(
                quicksum(energy_vars[l, n] for n in range(n_neighborhoods) if neighborhood_demands[n] > 0) >= 0.1 * location_capacities[l] * station_vars[l],
                f"Minimum_Battery_Level_Station_{l}"
            )
