...
class NeighborhoodMaintenanceOptimization:
    ...
    def solve(self, instance):
        ...
        M = 10000  # Big M value that should be sufficiently large
        ...
        # Task capacity limits for each team using Big M formulation
        for t in range(num_teams):
            for n in range(num_neighborhoods):
                model.addCons(neighborhood_vars[t, n] <= M * team_vars[t], f"BigM_ActiveTeamCapacity_{t}_{n}")
