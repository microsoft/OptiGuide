...
class LogisticsNetworkDesign:
    ...
    def generate_instance(self):
        ...
        renewable_capacity = {d: np.random.randint(10, 50) for d in range(self.Number_of_Depots)}
    ...
    def solve(self, instance):
        ...
        renewable_util_vars = {d: model.addVar(vtype="C", lb=0.0, ub=1.0, name=f"RenewableUtil_{d}") for d in range(number_of_depots)}
        ...
        for d in range(number_of_depots):
            model.addCons(
                charge_binary_vars[d] * renewable_capacity[d] >= renewable_util_vars[d] * renewable_capacity[d],
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'City_Cost_Lower_Bound': 450,
        'City_Cost_Upper_Bound': 3000,
        'Min_Depot_Cost': 421,
        'Max_Depot_Cost': 5000,
        'Min_Depot_Capacity': 590,
        'Max_Depot_Capacity': 2835,
        'Min_Operational_Capacity': 100,
        'Affinity': 5,
        'No_of_Scenarios': 0,
