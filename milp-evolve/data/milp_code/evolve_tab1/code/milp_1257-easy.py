...
class NeighborhoodMaintenanceOptimization:
    ...
    def generate_instance(self):
        ...
        budget_limits = np.random.randint(5000, 7000, self.num_teams) # Simplified budget constraint
        work_ranges = np.random.randint(50, 100, self.num_teams) # task units
    ...
    def solve(self, instance):
        ...
        model.setObjective(
            ...
            quicksum(50000 * unmet_security_vars[n] for n in range(num_neighborhoods) if priority_neighborhoods[n] == 1), # Removed env_impact_costs
            "minimize"
        )
        ...
        # Simplified Budget constraints for each team
        for t in range(num_teams):
