...
class DroneDeliveryOptimization:
    ...
    def get_instance(self):
        ...
        time_windows = np.random.randint(60, 120, size=self.PackagesPerMunicipality)
    ...
    def solve(self, instance):
        ...
        ### Simplified objective function without penalty variables
        model.setObjective(
        ...
        # Time window constraints without penalties
        for p in range(n_packages):
            for d in range(n_drones):
...
if __name__ == '__main__':
    ...
    parameters = {
        'NumberOfDrones': 75,
        'PackagesPerMunicipality': 39,
        'FuelCostRange': (202, 405),
        'DroneCapacityRange': (84, 140),
        'PackageDemandRange': (0, 1),
    }
