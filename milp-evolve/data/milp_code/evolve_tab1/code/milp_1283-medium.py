...
class WasteManagement:
    ...
    def solve(self, instance):
        ...
        M = sum(area_generation_rates)  # Big M
        ...
        # Constraints: Each area must be served by at least one truck
        for a in range(number_of_areas):
            model.addCons(quicksum(route_vars[t, a] for t in range(number_of_trucks)) == 1, f"Area_Truck_Service_{a}")
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'Min_Waste_Generation': 100,
        'Max_Waste_Generation': 500,
        'Min_Recycling_Rate': 250,
        'Max_Recycling_Rate': 2700,
    ...
    waste_management_optimizer = WasteManagement(parameters, seed=42)
