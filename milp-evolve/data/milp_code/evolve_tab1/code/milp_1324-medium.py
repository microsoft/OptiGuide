...
class ResidentialZoneDevelopment:
    ...
    def generate_instance(self):
        ...
        # Mutual exclusivity graph
        g = nx.erdos_renyi_graph(self.n_markets, 0.05)
    ...
    def solve(self, instance):
        ...
        # Clique inequalities for mutual exclusivity
        for clique in cliques:
            model.addCons(quicksum(market_vars[m] for m in clique) <= 1, f"Clique_Exclusivity_{cliques.index(clique)}")
