...
class SimplifiedDataCenterResourceAllocation:
    ...
    def generate_instance(self):
        ...
        semi_continuous_penalties = np.random.randint(1, 10, (self.n_centers, self.n_centers))
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'min_task_cost': 1653,
        'max_task_cost': 3000,
        'min_center_cost': 2484,
        'max_center_cost': 5000,
        'min_center_capacity': 951,
        'max_center_capacity': 2559,
        'link_probability': 0.52,
        'flow_capacity_min': 2500,
        'flow_capacity_max': 3000,
        'efficiency_penalty_min': 0.38,
        'efficiency_penalty_max': 400.0,
    }
