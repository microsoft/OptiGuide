    ...
    def solve(self, instance):
        ...
        for road, season in road_status.items():
            ...
            if season == 'rainy':
                ...
                objective_expr += penalty * 10  # Penalty weight

        ### New constraints, variables, objectives for Big M Formulation start here
        ...
        ### New constraints, variables, objectives for Big M Formulation end here
