...
class HealthcareFacilityLocation:
    ...
    def solve(self, instance):
        ...
        # Objective: Minimize total zoning and transportation costs
        ...
        total_cost = zoning_cost + transportation_cost
...
if __name__ == '__main__':
    ...
    solve_status, solve_time = healthcare_optimization.solve(instance)
