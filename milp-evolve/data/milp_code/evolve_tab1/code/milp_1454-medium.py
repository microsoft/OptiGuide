...
class HospitalBedOptimization:
    ...
    def solve(self, instance):
        ...
        # New constraint: Movement distance constraint (Critical zone)
        for z in range(n_zones):
...
if __name__ == '__main__':
    ...
    parameters = {
        'n_hospitals': 70,
        'n_zones': 120,
        'min_transport_cost': 1000,
        'max_transport_cost': 1200,
        'min_hospital_cost': 800,
        'max_hospital_cost': 2500,
        'min_bed_capacity': 500,
        'max_bed_capacity': 2000,
        'min_equipment_limit': 720,
        'max_equipment_limit': 950,
        'max_distance': 210,
    }
