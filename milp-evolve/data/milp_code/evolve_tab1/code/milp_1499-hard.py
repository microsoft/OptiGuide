...
class SetCoverSimplified:
    ...
    def solve(self, instance):
        ...
        model = Model("SetCoverSimplified")
        var_names = {}
        ...
        # Capacity constraint with uniform capacity
        for j in range(self.n_cols):
            model.addCons(var_names[j] <= self.max_capacity, f"capacity_{j}")
...
if __name__ == '__main__':
    ...
    set_cover_problem = SetCoverSimplified(parameters, seed=seed)
