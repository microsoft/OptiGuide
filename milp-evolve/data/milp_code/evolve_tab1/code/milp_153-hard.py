...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'facility_min_count': 30,
        'facility_max_count': 525,
    }
    
    auction_simplified = SimplifiedCombinatorialAuctionWithFLP(parameters, seed=seed)
    instance = auction_simplified.generate_instance()
    solve_status, solve_time = auction_simplified.solve(instance)
