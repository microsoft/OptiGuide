...
if __name__ == '__main__':
    seed = 42
    parameters = {
        'n_production_zones': 70,
        'n_distribution_zones': 67,
        'min_transport_cost': 12,
        'max_transport_cost': 30,
        'min_zone_cost': 600,
        'max_zone_cost': 702,
        'min_production_capacity': 234,
        'max_production_capacity': 250,
        'min_budget_limit': 810,
        'max_budget_limit': 1068,
        'max_transport_distance': 105,
    }
