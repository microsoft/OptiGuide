...
class MobileHealthcareOptimization:
    ...
    def generate_instance(self):
        ...
        # Create a proximity network graph using NetworkX
        G = nx.DiGraph()
        node_pairs = []
    ...
    def solve(self, instance):
        ...
        # Proximity constraint for neighboring zones
        for n in range(n_neighborhoods):
            model.addCons(
                quicksum(schedule_vars[(u, f"neighborhood_{n}")] for u in G.predecessors(f"neighborhood_{n}")) <= self.max_service_distance, 
                f"NeighboringProximityConstraint_Neighborhood_{n}"
            )
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'max_operational_cost': 750,
        'min_supply_limit': 600,
        'max_supply_limit': 3000,
        'min_service_level': 0.52,
        'max_service_level': 10.5,
        'max_service_distance': 500,
        'efficient_schedule_factor': 12.0,
