'''
Fixed Charge Multicommodity Network Flow (FCMCNF) with Clique Inequalities
'''
import random
import time
import numpy as np
...
if __name__ == '__main__':
    ...
    fcmcnf_cliques = FCMCNFWithCliques(parameters, seed=seed)
    instance = fcmcnf_cliques.generate_instance()
    solve_status, solve_time = fcmcnf_cliques.solve(instance)
