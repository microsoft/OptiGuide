...
class CommunityResourceAllocation:
    ...
    def solve(self, instance):
        neighborhood, removable_roads, service_demands, zebra_resource_costs, carbon_constraints, holding_costs, breakpoints, slopes = (
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'set_type': 'SET1',
        'set_param': 2400.0,
        'road_removal_prob': 0.59,
        'cost_sd': 1800.0,
        'holding_cost_mean': 700.0,
        'holding_cost_sd': 16.0,
        'demand_mean': 200.0,
        'demand_sd': 700.0,
        'breakpoints': (300, 750, 1200),
        'slopes': (9, 18, 27, 36),
    }
