...
if __name__ == '__main__':
    seed = 42
    parameters = {
        'n_customers': 80,  # Slightly increased number of customers
        'n_facilities': 110,  # Slightly increased number of facilities
        'demand_interval': (50, 360),
        'capacity_interval': (7, 120),
        'fixed_cost_scale_interval': (100, 111),
        'fixed_cost_cste_interval': (5, 50),
        'ratio': 3.75,
        'continuous_assignment': 3,
        'graph_type': 'barabasi_albert',
        'edge_probability': 0.8,
        'affinity': 8,
        'num_scenarios': 10,
        'demand_multiplier': 0.17,
        'budget_fraction': 0.75,  # Introduced budget fraction
    }
