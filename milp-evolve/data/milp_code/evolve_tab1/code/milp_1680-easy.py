...
class AdvancedFacilityLocation:
    ...
    def solve(self, instance):
        ...
        objective_expr = fixed_costs_expr + transportation_costs_expr + vehicle_costs_expr + factory_costs_expr + quicksum(unmet_demand_penalty * unmet_demand[i] for i in range(n_customers))
