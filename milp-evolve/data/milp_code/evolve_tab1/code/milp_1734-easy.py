...
class EmergencyResourceAllocation:
    ...
    def solve(self, instance):
        ...
        objective = total_cost + quicksum(efficiency_vars[node] for node in graph.nodes) + quicksum(emergency_vars[node] * emergency_penalties[node] for node in graph.nodes)
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'zoe_emergency_threshold': 2500,
    }
    # Now also include new parameters
    parameters.update({'BigM': 1e6})
