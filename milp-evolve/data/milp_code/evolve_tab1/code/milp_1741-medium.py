...
class EnergyEfficientSchedulingSimplified:
    ...
    def solve(self, instance):
        ...
        model = Model("EnergyEfficientSchedulingSimplified")
...
if __name__ == '__main__':
    ...
    optimizer = EnergyEfficientSchedulingSimplified(parameters, seed=seed)
