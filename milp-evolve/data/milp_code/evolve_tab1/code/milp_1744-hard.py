...
class SimplifiedProductionScheduling:
    ...
    def solve(self, instance):
        ...
        model = Model("SimplifiedProductionScheduling")
...
if __name__ == '__main__':
    ...
    production_scheduling = SimplifiedProductionScheduling(parameters, seed=seed)
