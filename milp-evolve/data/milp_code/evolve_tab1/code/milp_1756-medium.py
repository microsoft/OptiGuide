...
class EVChargingStationPlacement:
    ...
    def solve(self, instance):
        ...
        objective_expr = quicksum(fixed_costs[j] * use_stations[j] for j in range(n_stations)) + quicksum(
            installation_costs[i, j] * allocate[i, j] for i in range(n_zones) for j in range(n_stations))
