...
class AdvancedFacilityLocation:
    ...
    def solve(self, instance):
        ...
        # Reduce average wait time for specialized treatments during peak periods
        for j in range(n_facilities):
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'special_treatment_capacity_interval': (150, 1200),
        'peak_period_demand_increase_min': 0.1,
        'peak_period_demand_increase_max': 0.5,
    }
