...
class SimplifiedLoadBalancingOptimization:
    ...
    def solve(self, instance):
        ...
        model = Model("SimplifiedLoadBalancingOptimization")
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'min_gen_cost': 600,
        'max_gen_cost': 600,
        'min_gen_capacity': 150,
        'max_gen_capacity': 750,
        'min_shed_penalty': 50,
        'max_shed_penalty': 1500,
        'min_emission_penalty': 80,
        'max_emission_penalty': 120,
    }

    optimizer = SimplifiedLoadBalancingOptimization(parameters, seed=seed)
