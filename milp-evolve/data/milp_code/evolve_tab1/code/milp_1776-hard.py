...
class EventWorkerAllocationOptimization:
    ...
    def generate_instance(self):
        ...
        res = {
            ...
            'cliques': cliques,   ## ADDED CLIQUES
            'dependencies': dependencies  ## ADDED DEPENDENCIES
        }
        return res
    ...
    def solve(self, instance):
        ...
        ## UPDATE Here: Use of Cliques instead of mutual exclusivity and simple edge constraints
