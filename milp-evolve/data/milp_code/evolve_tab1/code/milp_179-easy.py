...
class SimplifiedCombinatorialAuctionWithFLP:
    ...
    def solve(self, instance):
        ...
        # Convex Hull Constraints: Min bids per facility and Conditional Opening
        for j in range(n_facilities):
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'facility_max_count': 37,
        'min_bids_per_facility': 2,
    }

    auction_and_patrol = SimplifiedCombinatorialAuctionWithFLP(parameters, seed=seed)
