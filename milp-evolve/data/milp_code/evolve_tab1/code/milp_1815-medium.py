...
class GISP_NDP:
    ...
    def generate_instance(self):
        ...
        # New energy consumption and shift data generation
    ...
    def solve(self, instance):
        G, E2, scenarios, energy_limits, shift_demands = instance['G'], instance['E2'], instance['scenarios'], instance['energy_limits'], instance['shift_demands']
        ...
        # New vars for energy consumption status and shift loads
