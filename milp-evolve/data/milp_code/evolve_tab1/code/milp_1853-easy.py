...
class ComplexFacilityLocation:
    ...
    def generate_instance(self):
        ...
        # Order facilities by fixed costs to support symmetry-breaking constraints
        sorted_indices = np.argsort(fixed_costs)
        res['facilities_ordered_by_cost'] = sorted_indices.tolist()
    ...
    def solve(self, instance):
        ...
        facilities_order = instance['facilities_ordered_by_cost']
        ...
        for idx in range(n_facilities - 1):
            j_first = facilities_order[idx]
            j_second = facilities_order[idx + 1]
            model.addCons(open_facilities[j_first] >= open_facilities[j_second], f"Symmetry_{j_first}_{j_second}")
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'vehicle_capacity_interval': (187, 375),
        ...
        'special_treatment_capacity_interval': (224, 1800),
        'peak_period_demand_increase_min': 0.24,
        'peak_period_demand_increase_max': 0.98,
        'n_periods': 36,
        'multi_period_variation': 0.17,
    }
