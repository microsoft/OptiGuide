...
class SimplifiedSetCover:
    ...
    def solve(self, instance):
        ...
        # Objective: Minimize total cost including set cover costs and activation costs
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'max_coef': 21,
        'n_crucial': 154,
        'activation_cost_low': 6,
        'activation_cost_high': 500,
    }

    simplified_problem = SimplifiedSetCover(parameters, seed=seed)
