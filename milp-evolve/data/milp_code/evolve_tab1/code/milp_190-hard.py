...
class RobustIndependentSet:
    ...
    def solve(self, instance):
        ...
        ### New constraints and variables using clique inequalities ###
        # Define the Clique Inequalities
        for count, clique in enumerate(cliques_of_interest):
            for u, v in combinations(clique, 2):
                model.addCons(var_names[u] + var_names[v] <= 1, name=f"clique_ineq_{count}_{u}_{v}")
