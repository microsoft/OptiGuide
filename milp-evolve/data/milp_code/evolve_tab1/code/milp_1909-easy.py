...
class BioWasteCollection:
    ...
    def generate_instance(self):
        ...
        res.update({'min_operational_load': min_operational_load, 'min_operational_fuel': min_operational_fuel})
    ...
    def solve(self, instance):
        ...
        min_operational_load = instance['min_operational_load']
        min_operational_fuel = instance['min_operational_fuel']
