...
class EmergencyResourceAllocation:
    ...
    def solve(self, instance):
        ...
        # Capacity constraints using clique inequalities
        for clique in cliques:
            for center in clique:
                clique_sum = quicksum(victim_demands[i] * rescue_vars[i, center] for i in clique if i != center)
                model.addCons(clique_sum <= center_capacities[center], name=f"CliqueCapacity_{center}_{clique}")
