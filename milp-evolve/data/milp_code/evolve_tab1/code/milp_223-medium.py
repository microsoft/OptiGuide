...
class AdvancedCombinatorialAuctionWithGraphConstraints:
    ...
    def solve(self, instance):
        ...
        model = Model("AdvancedCombinatorialAuctionWithGraphConstraints")
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'max_bundle_size': 20,
        'add_item_prob': 0.32,
        'facility_min_count': 40,
        'facility_max_count': 135,
        'n_exclusive_pairs': 175,
    }

    auction = AdvancedCombinatorialAuctionWithGraphConstraints(parameters, seed=42)
