...
class FCMCNF:
    ...
    def solve(self, instance):
        ...
        # Logical Constraints for critical edges with Big M formulation
        for (i, j) in self.critical_edges:
            ...
            model.addCons(critical_expr <= z_vars[f"z_{i+1}_{j+1}"] * self.big_M)
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'max_n_commodities': 471,
        'c_range': (164, 750),
        'd_range': (90, 900),
        'ratio': 3000,
        'k_max': 56,
        'er_prob': 0.66,
        'n_coverage_pairs': 750,
        'coverage_max_cost': 315,
        'n_vehicle_types': 27,
        'max_vehicles_per_type': 11,
        'fuel_range': (13.5, 33.75),
        'emission_range': (0.45, 0.45),
        'delay_range': (105.0, 1050.0),
        'max_fuel': 5000,
        'max_emission': 1000,
        'n_time_periods': 20,
        'n_suppliers': 324,
        'pollution_range': (5, 50),
        'noise_range': (300, 1200),
        'max_pollution': 500,
        'max_noise': 1500,
    }
