...
class IndependentSet:
    ...
    def solve(self, instance):
        ...
        # Define the knapsack constraint
        node_weight_constraints = quicksum(node_weights[node] * var_names[node] for node in graph.nodes)
        model.addCons(node_weight_constraints <= knapsack_capacity, name="knapsack")

        # Define objective to maximize node existence probability
