...
class AdvancedCombinatorialAuctionWithFLPBigM:
    ...
    def solve(self, instance):
        ...
        # Big M for mutual exclusivity
        for fac1, fac2 in mutual_exclusivity_pairs:
            model.addCons(y_vars[fac1] + y_vars[fac2] <= 1, f"MutualExclusivity_{fac1}_{fac2}")
            model.addCons(y_vars[fac1] <= M * (1 - y_vars[fac2]), f"BigM_{fac1}_{fac2}_1")
            model.addCons(y_vars[fac2] <= M * (1 - y_vars[fac1]), f"BigM_{fac1}_{fac2}_2")
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'max_bundle_size': 175,
        'add_item_prob': 0.17,
        'facility_min_count': 750,
        'facility_max_count': 1406,
        'complexity_mean': 225,
        'complexity_stddev': 1500,
        'n_exclusive_pairs': 777,
        'knapsack_constraints': 300,
        'n_workers': 2100,
        'n_shifts': 22,
        'max_shift_hours': 54,
        'overtime_cost_per_hour': 5,
        'regular_shift_hours': 3,
    }
