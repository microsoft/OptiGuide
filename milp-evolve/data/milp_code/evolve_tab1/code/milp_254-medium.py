...
class MarineProtectedAreas:
    ...
    def generate_instance(self):
        ...
        cliques_of_interest = [clique for clique in cliques if len(clique) <= self.max_clique_size]
    ...
    def solve(self, instance):
        ...
        # Additional constraints for highly interconnected cliques
        ...
        # Define combined objective to include both marine exploits and node existence probabilities
