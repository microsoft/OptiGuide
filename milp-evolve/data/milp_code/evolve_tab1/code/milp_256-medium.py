...
class SimplifiedFCMCNF:
    ...
    def solve(self, instance):
        ...
        # Symmetry Breaking constraints among nodes
        for i in range(self.n_nodes-1):
            model.addCons(x_vars[f"x_{i+1}_1_1"] <= x_vars[f"x_{i+2}_1_1"], f"sym_breaking_{i+1}")
...
if __name__ == '__main__':
    ...
    parameters = {
        'min_n_nodes': 10,
        'max_n_nodes': 33,
        'min_n_commodities': 112,
        'max_n_commodities': 392,
        'c_range': (205, 937),
        'd_range': (180, 1800),
        'ratio': 3000,
        'k_max': 420,
        ...
        'coverage_max_cost': 1470,
        'n_vehicle_types': 2187,
        'max_vehicles_per_type': 735,
        'fuel_range': (121.5, 303.75),
        'emission_range': (0.73, 0.73),
        'delay_range': (189.0, 1890.0),
        'max_fuel': 5000,
        'max_emission': 1000,
        'n_time_periods': 11,
        'n_suppliers': 2700,
        'pollution_range': (45, 450),
        'max_pollution': 3000,
    }
