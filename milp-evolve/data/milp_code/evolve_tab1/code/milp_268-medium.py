...
class ClinicalTrialResourceAllocation:
    ...
    def generate_instance(self):
        ...
        # New data for the added complexity
    ...
    def solve(self, instance):
        ...
        demographic_vars = {(g, j): model.addVar(vtype="B", name=f"Demographic_{g}_{j}") for g in range(5) for j in range(n_facilities)}  # 5 demographic groups
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'max_bundle_size': 80,
        'add_item_prob': 0.1,
        'facility_min_count': 140,
        'facility_max_count': 1890,
        'n_exclusive_pairs': 1181,
    }
