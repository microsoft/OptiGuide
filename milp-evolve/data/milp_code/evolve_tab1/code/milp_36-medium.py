...
class CombinatorialAuction:
    ...
    def solve(self, instance):
        ...
        # Objective: maximize the total price and minimize waste
        total_waste = quicksum(waste_vars[i] for i in range(len(bids)))
        total_value = quicksum(price * bid_vars[i] for i, (bundle, price) in enumerate(bids))
        objective_expr = total_value - self.waste_penalty * total_waste
