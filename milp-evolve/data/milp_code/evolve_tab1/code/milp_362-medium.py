...
class AdvancedLogisticsOptimization:
    ...
    def solve(self, instance):
        ...
        objective_expr = cost_term - self.flow_weight * flow_term + self.depot_penalty_weight * depot_penalty_term + self.time_penalty_weight * time_penalty_term + self.route_penalty_weight * route_penalty_term
