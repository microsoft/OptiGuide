...
class HCAN:
    ...
    def solve(self, instance):
        ...
        visit_segment_vars = {}
        for u, v in G.edges:
            visit_segment_vars[(u, v)] = {segment: model.addVar(vtype="B", name=f"VisitSegment_{u}_{v}_{segment}") for segment in range(1, piecewise_segments + 1)}
