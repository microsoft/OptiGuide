...
class ComplexTeamDeployment:
    ...
    def generate_instance(self):
        ...
        # Cost matrices
        team_costs = np.random.gamma(20, 2, size=(n_teams, n_locations))  # more complex cost distribution
        activation_costs = np.random.normal(100, 30, size=n_locations)  # diverse activation costs

        # Capacities and demands
        transportation_capacity = np.random.randint(50, 200, size=n_locations)  # more varied capacity
        team_demand = np.random.randint(10, 25, size=n_teams)  # increased team demand
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'min_skill_level': 0,
        'max_skill_level': 10,
        'min_skill_requirement': 3,
        'max_skill_requirement': 11,
    }
