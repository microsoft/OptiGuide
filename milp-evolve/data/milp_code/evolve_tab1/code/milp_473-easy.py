...
class CourierRouteOptimization:
    ...
    def generate_instance(self):
        ...
        # New semi-continuous flow variables data
        ...
        # Introduce logical conditions
        logical_conditions = []
        for _ in range(np.random.randint(2, 10)):
            node_pair = np.random.choice(graph.nodes, 2, replace=False)
            logical_conditions.append((node_pair[0], node_pair[1]))
        
        res['logical_conditions'] = logical_conditions
    ...
    def solve(self, instance):
        ...
        logical_conditions = instance['logical_conditions']
        ...
        # Adding logical conditions constraints
        for (node1, node2) in logical_conditions:
            model.addCons(assign_vars[node1] + assign_vars[node2] <= 1, name=f"LogicalCondition_{node1}_{node2}")
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'min_volume': 10000,
        'max_volume': 15000,
        'capacity_deviation_factor': 0.59,
        'supply_points': 375,
        'demand_points': 56,
    }
