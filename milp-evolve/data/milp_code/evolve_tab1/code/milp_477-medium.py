...
class MultipleKnapsack:
    ...
    def generate_instance(self):
        ...
        # Generate relational and sequence constraints
        big_m_constraints = list()
        for _ in range(self.num_relational_constraints):
            item_1, item_2 = np.random.choice(self.number_of_items, 2, replace=False)
            big_m_constraints.append((item_1, item_2))

        res['big_m_constraints'] = big_m_constraints
    ...
    def solve(self, instance):
        ...
        big_m_constraints = instance['big_m_constraints']
        ...
        # Big M constraints for relational constraints
        for item_1, item_2 in big_m_constraints:
            M = 1  # Big M value, since the variables are binary
            for j in range(number_of_knapsacks):
                model.addCons(var_names[(item_1, j)] - var_names[(item_2, j)] <= 0, f"RelationalConstraint_{item_1}_{item_2}_{j}")
...
if __name__ == '__main__':
    ...
    parameters = {
        'number_of_items': 200,
        'number_of_knapsacks': 30,
        'min_range': 90,
        'max_range': 150,
        'scheme': 'weakly correlated',
        'num_relational_constraints': 350,
    }
