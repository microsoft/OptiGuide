...
class CapacitatedFacilityLocation:
    ...
    def generate_instance(self):
        ...
        # New instance data starts here
        emission_factors = np.random.uniform(self.emission_factor_interval[0], self.emission_factor_interval[1], (self.n_customers, self.n_facilities))
        res['emission_factors'] = emission_factors
        # New instance data ends here
        return res
    ...
    def solve(self, instance):
        ...
        total_emissions = quicksum(emission_factors[i, j] * serve[i, j] for i in range(n_customers) for j in range(n_facilities))
        model.addCons(total_emissions <= self.environmental_cap, "EmissionCap")
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'fixed_cost_scale_interval': (1500, 1665),
        'fixed_cost_cste_interval': (0, 45),
        'ratio': 10.0,
        'continuous_assignment': 0,
        'environmental_cap': 10000.0,
        'emission_factor_interval': (0.52, 7.0),
    }
