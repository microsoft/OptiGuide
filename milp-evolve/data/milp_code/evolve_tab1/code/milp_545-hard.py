...
class DistributedNetworkOptimization:
    ...
    def get_instance(self):
        ...
        ### New data generation for enhanced complexity
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'min_compute': 0,
        'max_compute': 1054,
        'min_packet_effort': 1350,
        'max_packet_effort': 1518,
        'min_profit': 375.0,
        'max_profit': 1400.0,
        'max_machine_group_size': 3000,
        'min_efficiency': 37,
        'max_efficiency': 84,
        'min_computation_cost': 925,
        'max_computation_cost': 1400,
        'min_capacity_limit': 150,
        'max_capacity_limit': 843,
        'num_periods': 120,
        'min_storage_cost': 300,
