...
class SimplifiedMaxSatisfiability:
    ...
    def solve(self, instance):
        ...
        model = Model("SimplifiedMaxSatisfiability")
        var_names = {}  
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'road_connectivity_prob': 0.52,
    }

    maxsat = SimplifiedMaxSatisfiability(parameters, seed=seed)
