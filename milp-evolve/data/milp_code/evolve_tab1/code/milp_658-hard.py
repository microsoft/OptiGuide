...
class SupplyChainNetworkOptimization:
    ...
    def solve(self, instance):
        ...
        for i in range(num_distribution_centers):
            model.addCons(quicksum(transportation[i, j] for j in range(num_manufacturing_hubs)) == 1, name=f"distribution_connection_{i}")
...
if __name__ == '__main__':
    seed = 42
    parameters = {
        'min_manufacturing_hubs': 22,
        'max_manufacturing_hubs': 350,
        'min_distribution_centers': 12,
