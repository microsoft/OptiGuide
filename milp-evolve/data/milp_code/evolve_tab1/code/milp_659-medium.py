...
class NetworkMaintenance:
    ...
    def generate_instance(self):
        ...
        # Penalty costs removed for machine failures due to excessive load
    ...
    def solve(self, instance):
        ...
        # Penalty cost removed from objective
