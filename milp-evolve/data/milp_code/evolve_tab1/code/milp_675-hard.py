...
class SimplifiedFacilityLocation:
    ...
    def generate_instance(self):
        ...
        n_edges = (self.n_facilities * (self.n_facilities - 1)) // 4
    ...
    def solve(self, instance):
        ...
        secondary_objective_expr = -quicksum(serve[i, j] for i in range(n_customers) for j in range(n_facilities))
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'max_cliques': 100,
        'clique_limit': 15,
        'secondary_objective_weight': 0.52,
    }
