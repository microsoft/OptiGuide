...
if __name__ == '__main__':
    seed = 42
    parameters = {
        'min_energy_plants': 50,
        'max_energy_plants': 1200,
        'min_cities': 24,
        'max_cities': 800,
    }
