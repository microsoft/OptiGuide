...
class GISP:
    ...
    def generate_revenues_costs(self, G):
        for node in G.nodes:
            G.nodes[node]['revenue'] = int(np.random.normal(self.mean_revenue, self.std_revenue))
        for u, v in G.edges:
    ...
    def solve(self, instance):
        ...
        # Objective: Maximize revenues and minimize costs while introducing penalties for high-cost edges in E3.
