...
class EnhancedCombinatorialAuction:
    ...
    def generate_instance(self):
        ...
        capacities = self.min_capacity + (self.max_capacity - self.min_capacity) * np.random.rand(self.n_items + n_dummy_items)
    ...
    def solve(self, instance):
        ...
        for item, bid_indices in enumerate(bids_per_item):
            model.addCons(quicksum(bid_vars[bid_idx] for bid_idx in bid_indices) <= capacities[item], f"Capacity_{item}")
