...
class MicrochipManufacturing:
    ...
    def solve(self, instance):
        ...
        max_capacity = 5000  # reduced maximum capacity for a simpler problem
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'cost_deviation': 0.77,
        'additivity': 0.56,
        'add_component_prob': 0.74,
        'budget_factor': 612.5,
        'resale_factor': 0.75,
        'max_n_sub_orders': 300,
    }

    # Manufacturing-related parameters
    parameters.update({
        'max_capacity': 5000,  # reduced the maximum capacity for simplicity
    })
