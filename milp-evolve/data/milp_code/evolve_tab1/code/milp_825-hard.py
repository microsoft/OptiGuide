...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'min_value': 5,
        'max_value': 2250,
        'value_deviation': 0.78,
        'additivity': 0.76,
        'add_item_prob': 0.7,
        'mean_exchange_rate': 0.6,
        'exchange_rate_std': 0.7,
        'mean_esg_penalty': 0.79,
        'esg_penalty_std': 0.3,
        'mean_geopolitical_risk': 0.8,
        'geopolitical_risk_std': 0.72,
        'mean_technological_disruption': 0.69,
        'technological_disruption_std': 0.23,
        'mean_logistic_cost': 0.52,
        'logistic_cost_std': 0.76,
    }
