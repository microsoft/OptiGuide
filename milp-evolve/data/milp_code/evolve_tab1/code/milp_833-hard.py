...
class DataCenterInfrastructureOptimization:
    ...
    def get_instance(self):
        ...
        # Bandwidth limits and total budget
    ...
    def solve(self, instance):
        ...
        TotalCost = quicksum(FacilityConstruction[j] * construction_cost[j] for j in range(num_facilities)) + \
                    ...
                    quicksum(FacilityConstruction[j] * operational_cost[j] for j in range(num_facilities))
        ...
        total_budget_cost = quicksum(FacilityConstruction[j] * (construction_cost[j] + operational_cost[j]) for j in range(num_facilities))
