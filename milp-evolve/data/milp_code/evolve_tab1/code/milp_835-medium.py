...
class ExtendedMicrochipManufacturing:
    ...
    def generate_instance(self):
        ...
        # New data generation for semi-continuous variables
        ...
        # Extra data generation for network flows and diversity
    ...
    def solve(self, instance):
        ...
        # Constraints for semi-continuous variables
        for i in range(len(orders)):
        ...
        # New Constraints for network flows
        for u, v in G.edges:
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'min_cost': 240,
        'max_cost': 3000,
        'add_component_prob': 0.38,
        'dependency_prob': 0.8,
        'penalty_cost': 700,
        'resource_min_lower': 500,
