...
class EnhancedIndependentSet:
    ...
    def generate_instance(self):
        ...
        res = {'graph': graph, 'weights': weights, 'capacities': capacities, 'inequalities': inequalities}
        return res
    ...
    def solve(self, instance):
        ...
        objective_expr = quicksum(var_names[node] * weights[node] for node in graph.nodes)
