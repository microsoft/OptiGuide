...
class WarehouseLayoutOptimization:
    ...
    def solve(self, instance):
        ...
        unused_space = model.addVar(vtype="C", lb=0, name="UnusedSpace")
        
        # Objective: minimize the total cost (facility + transport + unused space penalties)
        ...
        for f in range(n_facilities):
            model.addCons(quicksum(demands[u] * transport_vars[f, u] for u in range(n_units)) <= spaces[f] + unused_space, f"Facility_{f}_Space")
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'min_facility_space': 450,
        'max_facility_space': 800,
    }
