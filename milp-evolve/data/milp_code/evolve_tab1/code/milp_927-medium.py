...
class WarehouseLayoutOptimization:
    ...
    def solve(self, instance):
        ...
        # Objective: minimize the total cost (facility + transport + congestion)
        model.setObjective(quicksum(facility_costs[f] * facility_vars[f] for f in range(n_facilities)) +
                           ...
                           quicksum(0.1 * congestion_cost_vars[f, u] for f in range(n_facilities) for u in range(n_units)), "minimize")
