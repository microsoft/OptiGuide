...
class SimplifiedSupplyChainNetwork:
    ...
    def solve(self, instance):
        ...
        model = Model("SimplifiedSupplyChainNetwork")
        ...
        objective_expr += transportation_cost_per_time * quicksum(delivery_times[j, k] * assign_delivery[j, k] for j in range(n_hubs) for k in range(n_depots))
...
if __name__ == '__main__':
    ...
    parameters = {
        'n_depots': 80,
        'n_hubs': 150,
        'demand_interval': (300, 900),
        'supply_interval': (400, 1000),
        'activation_cost_interval': (1000, 3000),
        'ratio': 225.0,
    }

    supply_chain = SimplifiedSupplyChainNetwork(parameters, seed=seed)
