...
class UrbanHousingManagement:
    ...
    def solve(self, instance):
        ...
        # Objective: minimize the total costs (management + infrastructure + urban surge)
...
if __name__ == '__main__':
    ...
    parameters = {
        ...
        'min_infrastructure_cost': 450,
        'max_infrastructure_cost': 468,
        'min_capacity': 2016,
        'max_capacity': 3000,
    }
