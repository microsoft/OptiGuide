...
class GraphColoring:
    ...
    def generate_instance(self):
        ...
        res = {'graph': graph, 'cliques': cliques}
        return res
    ...
    def solve(self, instance):
        ...
        # Incorporating Symmetry Breaking: Ensure the first node (0) uses the first color (0) to break symmetry
        model.addCons(var_names[(0, 0)] == 1)
