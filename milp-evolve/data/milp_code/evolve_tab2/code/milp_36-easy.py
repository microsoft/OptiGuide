...
class AdvancedGraphProblem:
    ...
    def solve(self, instance):
        ...
        model = Model("AdvancedGraphProblem")
...
if __name__ == '__main__':
    ...
    advanced_graph_problem = AdvancedGraphProblem(parameters, seed=seed)
    instance = advanced_graph_problem.generate_instance()
    solve_status, solve_time = advanced_graph_problem.solve(instance)
